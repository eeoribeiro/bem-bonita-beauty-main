              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  >
                    ...
                    Agendar horário com {professionalName.split(" ")[0]}
                  </BotaoLink>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-5xl px-5 lg:px-8">
            ...
            <div className="mt-14 grid gap-8 md:grid-cols-3">
              <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-card">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary text-magenta mb-5">
                  <Scissors className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-display">Corte a Seco e Curvatura Real</h3>
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Cada corte é planejado considerando o fator encolhimento, caimento e a densidade de
                  cada mecha, sem surpresas no comprimento final.
                </p>
              </div>

              <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-card">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary text-gold mb-5">
                  <Award className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-display">Saúde em Primeiro Lugar</h3>
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Procedimentos de mechas e tratamentos executados com avaliação prévia da fibra
                  capilar para preservar 100% da integridade dos cachos.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-border/70 bg-card p-6 shadow-card">
                ...
                <h3 className="text-xl font-display">Educação Home Care</h3>
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Você não sai apenas com o cabelo lindo: aprende exatamente como lavar, fitar e
                  manter a definição no seu dia a dia.
                </p>
              </div>
            </div>
            ...
            <div className="mt-20 overflow-hidden rounded-[2.5rem] border border-border/70 bg-card p-8 shadow-card md:grid md:grid-cols-[1fr_1.1fr] md:gap-10 md:items-center">
              ...
              <div className="mt-6 md:mt-0 space-y-4">
                <p className="eyebrow">Ambiente Exclusivo</p>
                <h3 className="text-2xl sm:text-3xl font-display">Um refúgio para você se cuidar</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Localizado no coração de Ponte Nova, no Lanna Shopping, o espaço foi desenhado para
                  proporcionar uma experiência intimista, com café fresco, música relaxante e
                  atendimento focado exclusivamente em você.
                </p>
                <div className="pt-2">
                  <BotaoLink
